...
<style>
 ...
 /* CSS class for the box shadow effect */
 /* .box-shadow-content {
...
p{
  ...
  $projectQuery = "SELECT * FROM `project` WHERE RIGHT(CHASSISNO, 4) = '$search' AND BRANCHESDEALERS= '$userPlace' ";
...
<?php
  ...
  $aProjectQuery = "SELECT * FROM `a_project` WHERE RIGHT(CHASSISNO, 4) = '$search'AND BRANCHESDEALERS= '$userPlace' ";
...
<button type="button" onclick="toggleContent()">Next<i class="fa fa-arrow-right" aria-hidden="true"></i></button>
</form>
</div>
  <br>
...
<br>
 ...
 <p style="text-align:center; margin-left: -91%;"><b>File Details</b></p>
  ...
  <script>
        // JavaScript function to toggle the content visibility
        function toggleContent() {
            const initialContent = document.getElementById('initial-content');
            const additionalContent = document.getElementById('additional-content');
            
            if (initialContent.style.display === 'block') {
  ...
  // If there are more than 7 cells, populate all 28 fields
  rowData = {
  ...
  // Now you have the rowData object populated with the relevant data

  // Rest of your code to populate the form and perform actions
